...
function header_html(){
    ...
    echo '<li style="margin-bottom: 10px;"><button style="font-size: 15px; padding: 10px 20px;">English</button></li>';
    echo '<li style="margin-bottom: 10px;"><button style="font-size: 15px; padding: 10px 20px;">French</button></li>';
    echo '</ul>';
    echo '</div>';
