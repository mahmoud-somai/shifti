...
function header_html(){
    ...
    echo '<li style="margin-bottom: 20px;"><button style="font-size: 15px; padding: 15px 30px;">English</button></li>';
    echo '<li style="margin-bottom: 20px;"><button style="font-size: 15px; padding: 15px 30px;">French</button></li>';
    echo '</ul>';
    echo '</div>';
