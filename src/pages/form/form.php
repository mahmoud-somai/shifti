...
function form_html(){
    ...
    echo '<input type="text" name"plugin-token" id="token" style="padding: 8px; border: 1px solid #ccc; border-radius: 4px; width: 40%; display: inline-block; margin-left: 5px;">';
