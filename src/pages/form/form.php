...
function form_html() {
    ...
    echo '    <div class="overlay-container" style="position: absolute; top: 50%; left: 50%; border-radius:25%; transform: translate(-50%, -50%); width: 300px; background-color: #FFB1B1; padding: 20px; text-align: center;">';
