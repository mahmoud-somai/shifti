    ...
    jQuery(document).ready(function($) {
        $("#export-form").submit(function(event) {
            ...
            var actions = [
                ...
                {action: "get_orders_details_data", url: "http://localhost:8080/woocommerce/order_details", message: "Orders details exported with success"}  // Added order details action
            ];
