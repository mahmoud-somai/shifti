...
function form_html(){
    ...
    echo '<h1 style="width: 100%; margin-bottom: 20px;">Link Shop</h1>'; 
    echo '<div class="form-group" style="display: inline-block; width: 100%;">';
    echo '<span style="font-size: 20px; color: #333; width: 20%; text-align: left; display: inline-block;">Plugin Token : </span>';
