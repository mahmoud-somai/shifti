    ...
    jQuery(document).ready(function($) {
        $("#export-form").submit(function(event) {
            ...
            var actions = [
                ...
                {action: "get_orders_details_data", url: "http://localhost:8080/woocommerce/orderDetails", message: "Order details exported with success"} // Added order details action
];
            ];
