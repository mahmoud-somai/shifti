...
function form_html(){
    ...
    echo '<div class="form-group" style="display: inline-block; margin-bottom: 15px;">';
    echo '<label for="token" style="font-size: 16px; color: #333; display: inline-block; width: 50%;">Plugin Token:</label>';
    echo '<input type="text" name"plugin-token" id="token" style="padding: 8px; margin-left: 10px; border: 1px solid #ccc; border-radius: 4px; width: 60%; display: inline-block;">';
    echo '</div>';
