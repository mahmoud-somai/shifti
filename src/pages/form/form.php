...
function form_html(){
    ...
    echo '        <h3 style="margin-bottom: 10px; color: #4CAF50;">Export Data</h3>'; 
    ...
    echo '            <div id="success-messages" style="margin-top: 10px; text-align: left; color: #4CAF50; font-size: 14px;"></div>'; // Success messages container
