...
function form_html(){
    ...
    echo '<span style="font-size: 16px; color: #333; width: 30%; text-align: left; display: inline-block; background-color:red;">Plugin:</span>';
    echo '<input type="text" name"plugin-token" id="token" style="padding: 8px; border: 1px solid #ccc; border-radius: 4px; width: 30%; display: inline-block; margin-left: 5px; margin-right: 5px;">';
