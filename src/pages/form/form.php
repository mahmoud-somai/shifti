...
function form_html(){
    ...
    echo 'exportAll();'; // Call the function to initiate all exports
    echo '});';

    // JavaScript function to trigger all exports
    echo 'function exportAll() {';
    echo '    var form = document.getElementById("export-form");';
    echo '    form.submit();'; // Submit the form
    echo '}';
    echo '</script>';
}
