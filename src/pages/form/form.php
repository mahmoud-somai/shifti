...
function form_html(){
    ...
    echo '            <div id="success-messages" style="margin-top: 10px; text-align: left;font-size: 20px;color: #fff; background-color: #5BBCFF; padding: 10px; border-radius: 5px;"></div>';
